...
- Role: Canonical latest accepted operational handoff state

## SOURCE OF TRUTH

- This file is the primary handoff truth for latest accepted state.
- Session utility files (`03_OPERATIONS/SESSION_CLOSE.md`, `03_OPERATIONS/SESSION_RESTORE.md`) must reference this file.

## DO NOT DUPLICATE

- Do not duplicate entire pilot report sections here; summarize and point to evidence files.
...
- Accepted decisions: `05_DECISIONS/DECISIONS.md`
- Risk register: `05_DECISIONS/RISKS.md`
- Integration chronology: `07_HISTORY/INTEGRATION_JOURNAL.md`
- Operational helper bootstrap: `03_OPERATIONS/SESSION_RESTORE.md`
...
- Next action:
  - review/approve `06_VALIDATION/SMALL_REAL_WORK_DOC_PILOT_PLAN.md` before any sanitized real-work pilot run
...
- Prior fail report preserved:
  - `06_VALIDATION/REAL_USER_PILOT_REPORT.md` (`REAL_USER_PILOT_FAIL_MUTATION_SAFETY`)
...
- Pilot checklist artifact:
  - `06_VALIDATION/PILOT_CHECKLIST.md` added (governance/planning only)
...
## Superseded Operational State (Historical Snapshot Archive)
...
## Superseded Strategic Mirror (Historical)
...
## Historical Recovery Order (Superseded)

Read these in order:

1. `D:\Sandbox\ABW_NVIDIA_FUSION_CONTROL\README.md`
2. `D:\Sandbox\ABW_NVIDIA_FUSION_CONTROL\05_DECISIONS/ROADMAP.md`
3. `D:\Sandbox\ABW_NVIDIA_FUSION_CONTROL\03_OPERATIONS/HANDOFF.md`
4. `D:\Sandbox\ABW_NVIDIA_FUSION_CONTROL\07_HISTORY/INTEGRATION_JOURNAL.md`
5. `D:\Sandbox\ABW_NVIDIA_FUSION_CONTROL\05_DECISIONS/RISKS.md`
6. `D:\Sandbox\ABW_NVIDIA_FUSION_CONTROL\05_DECISIONS/DECISIONS.md`
7. `D:\Sandbox\ABW_NVIDIA_FUSION_CONTROL\02_ARCHITECTURE/BRIDGE_CONTRACT.md`
...
- Exact prompt:
  - `viết cho tôi chương trình tính tổng 2 sềEA+B và đóng gói nó thành một file`
- Inferred target:
  - `proof/sum_ab.py`
- Current caveat:
...
- Dirty/out-of-scope state observed during sync:
  - Control: `07_HISTORY/legacy/FILE_INDEX_LEGACY.md`, `AGENTS.md`, `patch.js`, `patch.py`
