...
- Owner: Auditor
- Role: Canonical historical evidence artifact

## SOURCE OF TRUTH

- This file preserves run-specific evidence and verdict chronology.
- Fail and rerun artifacts are complementary; none should overwrite another.

## DO NOT DUPLICATE

- Do not copy full report content into handoff/session files.
- Summarize and link this artifact from canonical operational docs.
