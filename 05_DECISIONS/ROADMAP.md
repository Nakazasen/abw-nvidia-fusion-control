...
- Owner: Architect + Governance Recorder
- Role: Strategic roadmap and durable capability boundaries

## SOURCE OF TRUTH

- This file is the canonical strategic roadmap truth.
- Point-in-time local status snapshots belong in `05_DECISIONS/ROADMAP_STATE.md`.

## DO NOT DUPLICATE

- Do not copy full sprint evidence blocks from handoff/reports into this file.
- Summarize strategic implications only; keep detailed evidence in reports/journal/handoff.
...
- Small sanitized real-work pilot planning artifact now exists at `06_VALIDATION/SMALL_REAL_WORK_DOC_PILOT_PLAN.md` and must be reviewed/approved before any pilot execution.
...
- Every roadmap change must be recorded in `05_DECISIONS/DECISIONS.md`.
...
- Treat `05_DECISIONS/ROADMAP.md`, `03_OPERATIONS/HANDOFF.md`, `07_HISTORY/INTEGRATION_JOURNAL.md`, `05_DECISIONS/RISKS.md`, and `05_DECISIONS/DECISIONS.md` as a single governance set.
- After each sprint close, update the governance set before the next builder prompt is issued.
- If implementation order changes, record the reason in `05_DECISIONS/DECISIONS.md`, note the risk in `05_DECISIONS/RISKS.md`, and update the next-step truth in `03_OPERATIONS/HANDOFF.md`.
...
- update `05_DECISIONS/ROADMAP.md`
- add `05_DECISIONS/DECISIONS.md` entry
- add `05_DECISIONS/RISKS.md` entry
- update `03_OPERATIONS/HANDOFF.md`
...
## 2026-05-04 Update - Gate Selects Targeted Manual Path Revalidation Rerun
